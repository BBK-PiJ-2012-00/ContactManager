...
public interface ContactManager { 
	...
	* duplicates. 
	*
	* (Corrected method name from getFutureMeetingList to reflect the fact that
	* it can return meetings from any date.
	* 
	* @param date the date 
	...
	* empty, or any of the contacts does not exist, or if the date
	* is in the future. 
